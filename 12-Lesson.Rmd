...
You then check for spatial autocorrelation in the residuals. This is done by first defining the weights matrix and then applying Moran's I test as follows.
...
You then fit a spatial lag model using the `lagsarlm()` function from the {spatialreg} package. The model is
$$
