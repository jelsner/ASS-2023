...
The area of the hexagons (default spatial geometry) should be larger than the area of a circle defined by the variogram model range as the radius (but not too much larger)
