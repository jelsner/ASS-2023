...
Then use the functions from {ggplot2} to graph the number of tornadoes by year using lines to connect the values neighboring values of the variable on the x-axis (`Year`)
