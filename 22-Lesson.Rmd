...
A model should be capable of generating fake data that are statistically indistinguishable from the real data. With a point pattern model you produce samples of event locations with the `simulate()` function
