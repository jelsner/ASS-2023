...
Student Hours: TR 9:15-10:30 a.m., 2-3 p.m. The best way to get a hold of me is through email: [jelsner\@fsu.edu](mailto:jelsner@fsu.edu){.email}.

This course is a survey of methods to describe, analyze, and model geographic data using R. Focus is on applications. I emphasize how spatial statistical methods are related through the concept of spatial autocorrelation.

During each lesson I will work through and explain the R code within an `xx-Lesson.Rmd` file. The notes in the files are comprehensive, so you can work through them on your own.
...
Help with all aspects of R programming is ubiquitous on the web. A list of some of the sites related to spatial analysis and modeling using R are listed in the syllabus.

A new resource on getting started with R and R spatial I came across my desk yesterday. - [Getting started with R and R-spatial](https://bakaniko.github.io/foss4g2022-getting-started-rspatial/)

Switch markdown editing mode from Source to Visual.
...
Today I show you how to work with small bits of data using functions from the {base} packages. The {base} packages are included in your initial installation. The functions form these packages provide the scaffolding for working with the code, but much of what you will do in this class involve functions from other packages.
