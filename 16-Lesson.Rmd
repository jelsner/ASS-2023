...
Plot the $K(r)$ function from the data and from a homogeneous Poisson model.
...
The plot reveals a difference in the expected number of additional events using the tornado reports (black line) and from the null hypothesis model of CSR. For a given distance there are more events nearby other events (large $K(r)$ than would be expected by chance.
