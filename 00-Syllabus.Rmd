...
## GIS5122: Applied Spatial Statistics {.unnumbered}
...
|------|-------------------------|-----------------------------------------|
| 1    | August 23, 25           | Syllabus and setup                      |
| 2    | August 30, September 1  | Data frames & graphs                    |
| 3    | September 6, 8          | Spatial data                            |
| 4    | September 13, 15        | Joins & interpolation                   |
| 5    | September 20, 22        | Maps                                    |
| 6    | September 27, 29        | Neighborhoods & spatial autocorrelation |
| 7    | October 4, 6            | Spatial regression models               |
| 8    | October 11, 13          | Geographic regression                   |
| 9    | October 18, 20          | Point pattern data                      |
| 10   | October 25, 27          | Spatial intensity                       |
| 11   | November 1, 3           | Spatial point pattern models            |
| 12   | November 8, 10          | Variography                             |
| 13   | November 15, 17         | Spatial interpolation                   |
| 14   | November 29, December 1 | Simulation                              |
...
-   Navigate to \<[[https://github.com/jelsner/ASS-2022\\\\](https://github.com/jelsner/ASS-2022){.uri}](%5Bhttps://github.com/jelsner/ASS-2022\%5D(https://github.com/jelsner/ASS-2022)%7B.uri%7D){.uri}\>
