...
Suppose you are interested in the average number of tornadoes at a distance of exactly 50 km. You use the `approx()` function to interpolate the value of `nT` at a distance of 50 km.
```{r}
approx(x = K.df$r, 
       y = K.df$nT,
       xout = 50)$y
