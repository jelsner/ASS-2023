...
We naturally seek patterns within a collection of events. A pattern that often quickly gets our attention is clustering. Clusters of stars in the night sky were defined by the ancients as a constellation

A cluster of events in a particular region begs for an explanation. Why do events occur more often in one region compared to another region?
