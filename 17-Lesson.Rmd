...
An example of a Cox model is the mixed Poisson process in which a  variable $\Lambda$ is generated from some distribution that allow only positive numbers and then, conditional on $\Lambda$, a homogeneous point process is generated. 
