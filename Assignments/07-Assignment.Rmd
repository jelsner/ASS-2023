...
(b) Transform the coordinate reference system (CRS) of the geometry in `Torn.sf` to an Albers equal-area conic projection centered on the state of Iowa using the ESPG code 26975. (5)
...
(f) Determine the average intensity of tornado reports for the state as a whole. Then make a map showing the local intensity of the tornado reports using the `plot()` method. Which part of the state has experienced the fewest tornadoes (southwest, northwest, northeast, or southeast)? (10)
