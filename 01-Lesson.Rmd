...
Student Hours: TR 9:15-9:45 a.m., MW 2:15-3 p.m. The best way to get a hold of me is through email: [jelsner\@fsu.edu](mailto:jelsner@fsu.edu){.email}.
...
After installing R and RStudio, install git
...
Finally you can unfork your repository (see <https://nickymeuleman.netlify.app/blog/unfork-github-repo>)

Help with all aspects of git, GitHub, and R programming is ubiquitous on the web. A list of some of the sites related to spatial analysis and modeling using R are listed in the syllabus
...
I will start by showing you how to work with small bits of data using functions from the {base} packages. The {base} packages are included in your initial installation. The functions form these packages provide the scaffolding for working with the code, but much of what you will do in this class involve functions from other packages

Here is a new resource on getting started with R and R spatial - [Getting started with R and R-spatial](https://bakaniko.github.io/foss4g2022-getting-started-rspatial/)
...
6.  Fix any errors
7.  Email your completed assignment `Rmd` file (not the `html`) to [jelsner\@fsu.edu](mailto:jelsner@fsu.edu){.email}
