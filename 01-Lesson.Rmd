...
## Download course materials and open the syllabus file {.unnumbered}

-   Navigate to [<https://github.com/jelsner/ASS-2022>](https://github.com/jelsner/QG-2022){.uri}
-   Click on the bright green Code button
-   Download ZIP
-   Unzip the file on your computer
-   Open the `ASS-2022.Rproj` file

## Open the syllabus file {.unnumbered}
...
You can use the arrow keys to retrieve previous commands. Each command is stored in the history file. The up-arrow key moves backwards through the history file. The left and right arrow keys move the cursor along the line.
