...
Integration is done by adding up the intensity at locations x weighted by a particular value. The locations x and their weight values are constructed using the `ipoints()` function.
