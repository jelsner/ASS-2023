...
Finally, is the amount of sleep for a student related to when they go to bed? If you use numeric variables on both the x and y axes then you get a scatter plot.
```{r}
plot(x = df$ToSleep,
     y = df$SleepHrs)
```
