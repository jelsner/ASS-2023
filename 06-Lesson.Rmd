...
The cells are always in a rectangular arrangement. Values outside an irregular domain are set to `NA` and are not plotted
...
The value of .75 indicates high level of tornado clustering at the 1 degree lat/lon resolution
