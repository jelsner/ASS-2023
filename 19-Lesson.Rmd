...
Let's compare the inhibition model used to describe the Swedish pine saplings data with a cluster model for describing the Lansing Woods maple trees (in the `ppp` object called `lansing` from the {spatstat} package).
