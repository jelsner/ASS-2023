...
In practice you focus on a model for the variogram $\gamma(h)$. But to understand the variogram it helps to first consider the covariogram. This is because of your familiarity with the idea of nearby things being more correlated than things farther away.

To make things simple without loss in generality, start with a 4 x 6 grid of equally spaced surface air temperatures across a field in degrees C.
...
Plot the number of point pairs used in the calculation of the variogram as a function of lag distance.
