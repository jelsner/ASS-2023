...
_Announcement_ Starting today all remaining lessons will be via Zoom. I will start the lesson at 8 a.m. and record it so you can watch it live or later at your convenience.
...
Interest centers on being able to predict the probability of a copper ore from the distance to the lineaments. 
...
Integrating (summing) the predictions over the domain area equals the abundance (number of ore deposits).
